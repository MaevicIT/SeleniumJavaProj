...
public class SafariTests extends TestRunner {
    private WebDriver driver;
    private Tests test;

    public SafariTests(WebDriver driver, Tests test) {
        this.driver = driver;
        this.test = test;
    }
    ...
    private void runImagesTest(String url) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("image_inspection_results_Safari.txt"))) {
