...
public class FirefoxTests extends TestRunner {
    private WebDriver driver;
    private Tests test;

    public FirefoxTests(WebDriver driver, Tests test) {
        this.driver = driver;
        this.test = test;
    }
    ...
    private void runImagesTest(String url) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("image_inspection_results_FireFox.txt"))) {
